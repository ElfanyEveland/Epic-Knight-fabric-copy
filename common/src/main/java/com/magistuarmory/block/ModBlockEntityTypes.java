...
public class ModBlockEntityTypes
{
    ...
    static
    {
		WOOD_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(WOOD_PAVISE, a, b), ModBlocks.WOOD_PAVISE.get()).build();
		GOLD_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(GOLD_PAVISE, a, b), ModBlocks.GOLD_PAVISE.get()).build();
		STONE_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(STONE_PAVISE, a, b), ModBlocks.STONE_PAVISE.get()).build();
		IRON_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(IRON_PAVISE, a, b), ModBlocks.IRON_PAVISE.get()).build();
		DIAMOND_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(DIAMOND_PAVISE, a, b), ModBlocks.DIAMOND_PAVISE.get()).build();
		NETHERITE_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(NETHERITE_PAVISE, a, b), ModBlocks.NETHERITE_PAVISE.get()).build();
		TIN_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(TIN_PAVISE, a, b), ModBlocks.TIN_PAVISE.get()).build();
		COPPER_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(COPPER_PAVISE, a, b), ModBlocks.COPPER_PAVISE.get()).build();
		SILVER_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(SILVER_PAVISE, a, b), ModBlocks.SILVER_PAVISE.get()).build();
		BRONZE_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(BRONZE_PAVISE, a, b), ModBlocks.BRONZE_PAVISE.get()).build();
		STEEL_PAVISE_BUILDER = () -> FabricBlockEntityTypeBuilder.create((a, b) -> new PaviseBlockEntity(STEEL_PAVISE, a, b), ModBlocks.STEEL_PAVISE.get()).build();
